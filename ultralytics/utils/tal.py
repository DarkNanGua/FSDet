...
class TaskAlignedAssigner(nn.Module):
    ...
    def _forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt):
        ...
        Returns:
            ...
            target_gt_idx (Tensor): shape(bs, num_total_anchors)
        """
        mask_pos, align_metric, overlaps, mask_nor = self.get_pos_mask(
        ...
        return target_labels, target_bboxes, target_scores, fg_mask.bool(), target_gt_idx,mask_nor
    ...
    def get_pos_mask(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes, anc_points, mask_gt):
        ...
        mask_nor = mask_in_gts * mask_gt * (1.0 - mask_pos)

        return mask_pos, align_metric, overlaps, mask_nor
    ...
    def iou_calculation(self, gt_bboxes, pd_bboxes):
        ...
        # return bbox_ps(gt_bboxes, pd_bboxes).squeeze(-1).clamp_(0)
